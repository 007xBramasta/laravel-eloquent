...
class Customer extends Model
{
    ...
    {
        return $this->hasOneThrough(virtualAccount::class, Wallet::class, "customer_id", "wallet_id", "id", "id"); //wallet pake customer_id dan id dari customer virtual account pake wallet_id dan id dari wallet
    }
